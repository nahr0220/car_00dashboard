# ===============================================================
# 자동차 이전등록 대시보드 (최종 통합본 - 모든 그래프 및 최적화 포함)
# ===============================================================
...
def get_con():
    ...
    con.execute("SET memory_limit = '1GB'") # 메모리 부족으로 인한 튕김 방지
...
if not periods.empty:
    ...
    market_help_msg = "전체: 전체 데이터 / 중고차: 개인+매매업자 / 유효: 매매업자만 / 마케팅: 일반소유용 매매업자거래"
